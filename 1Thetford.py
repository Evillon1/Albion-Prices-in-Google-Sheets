...
thread1 = Thread(target=set.res, args=('WOOD', 4))
thread2 = Thread(target=set.res, args=('PLANKS', 6))
thread3 = Thread(target=set.res, args=('HIDE', 8))
thread4 = Thread(target=set.res, args=('LEATHER', 10))
thread5 = Thread(target=set.res, args=('ORE', 12))
thread6 = Thread(target=set.res, args=('METALBAR', 14))
